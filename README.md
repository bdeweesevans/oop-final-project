...
```bash
javac -cp "lib/*" src/controller/Main.java src/**/*.java
```

This ensures all external library JARs (listed below) are added to the classpath.
...
```bash
java -cp "lib/*:src" controller.Main
```
